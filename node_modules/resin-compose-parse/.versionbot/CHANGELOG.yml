...
- commits:
    - author: Pablo Carranza Velez
      body: >-
        ...
        Also, the function passed to _.map should receive (value, key) so we
        needed to
...
- commits:
    - author: Ariel Flesler
      ...
      subject: >-
        Remove update.strategy and handover-timeout default labels from the
        default composition
...
- commits:
    - author: Akis Kesoglou
      body: >-
        Validation would fail in a weird way if version was specified as an
...
- commits:
    - author: Pablo Carranza Velez
      ...
      subject: >-
        Coerce all service ports into strings, and validate them with the regex
        the supervisor uses
...
- commits:
    - author: Akis Kesoglou
      body: >-
        Useful to “wrap” Dockerfile projects as a resin-compatible
...
- commits:
    - author: Akis Kesoglou
      body: >-
        The Supervisor only supports dependencies specified as an array, so
        check and warn the user if they’re using the (deprecated at schema
        version 3.0) map notation.
      footers:
        change-type: minor
        connects-to: '#5'
...
- commits:
    - author: Akis Kesoglou
      body: >-
        The previous one had subtle bugs and didn’t seem capable to validate a
        full schema.
      footers:
        change-type: minor
