...
class PinejsClientCoreTemplate {
    constructor(params) {
        this.apiPrefix = '/';
        this.passthrough = {};
    ...
    prepare(params) {
        ...
        const transformFn = paramsObj.method === 'GET'
...
function PinejsClientCoreFactory(Promise) {
    ...
    class PinejsClientCore extends PinejsClientCoreTemplate {
        request(params, overrides) {
            ...
            try {
                ...
                method = (_a = method !== null && method !== void 0 ? method : overrides.method) !== null && _a !== void 0 ? _a : 'GET';
                method = method.toUpperCase();
                const opts = {
                    ...this.passthrough,
                    ...((_b = this.passthroughByMethod[method]) !== null && _b !== void 0 ? _b : {}),
                    ...passthrough,
                    url,
                    body,
                    ...overrides,
